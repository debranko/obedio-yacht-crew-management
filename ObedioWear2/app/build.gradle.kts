...
android {
    namespace = "com.example.obediowear2"
    compileSdk {
        version = release(36)
    }

    defaultConfig {
        applicationId = "com.example.obediowear2"
        minSdk = 30
        targetSdk = 36
        versionCode = 1
        versionName = "1.0"
...
dependencies {
    ...
    // Wear OS Compose (additional)
    implementation("androidx.wear.compose:compose-material:1.3.1")
    implementation("androidx.wear.compose:compose-foundation:1.3.1")
    implementation("androidx.wear.compose:compose-navigation:1.3.1")

    // Horologist for rotary input and Wear OS helpers
    ...
    // MQTT - hannesa2 fork (AndroidX compatible)
