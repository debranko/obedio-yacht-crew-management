...
start http://10.158.214.151:5555
echo.
echo Prisma Studio opened at http://10.158.214.151:5555
echo.
pause
goto menu
...
start http://10.158.214.151:8888
echo.
...
echo ========================================
echo.
set /p NEW_IP="Enter new IP address (e.g., 10.158.214.151): "
